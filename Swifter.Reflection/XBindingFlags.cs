namespace Swifter.Reflection
{
    ...
    public enum XBindingFlags
    {
        ...
        /// </summary>
        RWNoFoundException = 0x800,
        /// <summary>
        /// 在 OnReadAll 中跳过具有类型默认值的成员。
        /// </summary>
        SkipDefaultValue = 0x1000,

        /// <summary>
        /// XTypeInfo 创建时默认的标识。
        /// </summary>
        Default = Public | Instance | Field | Property | Indexer | Method | RWCannotGetException | RWCannotSetException | RWNoFoundException
    }
}