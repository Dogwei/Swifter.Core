...
namespace Swifter.Data
{
        ...
        where TTransaction : IDbTransaction
    {
        ...
        {
            return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, "ProxyProviderFactory", typeof(TConnection).Namespace);
        }
        ...
        public sealed class ProxyConnection : DbConnection
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyConnection), typeof(TConnection).FullName);
            }
        }
        ...
        public sealed class ProxyCommand : DbCommand
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyCommand), typeof(TCommand).FullName);
            }
        }
        ...
        public sealed class ProxyDataReader : DbDataReader
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyDataReader), typeof(TDataReader).FullName);
            }
        ...
        public sealed class ProxyParameter : DbParameter
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyParameter), typeof(TParameter).FullName);
            }
        }
        ...
        public sealed class ProxyParameterCollection : DbParameterCollection
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyParameterCollection), typeof(TParameterCollection).FullName);
            }
        }
        ...
        public sealed class ProxyTransaction : DbTransaction
        {
            ...
            public override string ToString()
            {
                return StringHelper.Format("{0}.{1}[\"{2}\"]", GetType().Namespace, nameof(ProxyTransaction), typeof(TTransaction).FullName);
            }
        }
    }
}
