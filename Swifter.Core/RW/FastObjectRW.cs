...
namespace Swifter.RW
{
    ...
    public abstract class FastObjectRW<T> : IDataRW<string>, IDirectContent, IInitialize<T>
    {
        ...
        internal static FastObjectRWOptions currentOptions = FastObjectRW.DefaultOptions;
        ...
        public ValueCopyer<string> this[string key]
        {
            get
            {
        ...
        public IEnumerable<string> Keys
        {
            get
            {
                return StaticFastObjectRW<T>.StringKeys;
            }
        }
        ...
        public int Count
        {
            get
            {
                return StaticFastObjectRW<T>.StringKeys.Length;
            }
        }
        ...
        public long ObjectId
        {
            get
            {
                return TypeInfo<T>.IsValueType ? 0 : (long)Tools.Pointer.UnBox(content);
            }
        }
        ...
        {
            return typeof(FastObjectRW).FullName + "<" + typeof(T).FullName + ">";
        }
        ...
        IDataReader<TKey> IDataReader.As<TKey>()
        {
            ...
            return new AsDataReader<string, TKey>(this);
        }
        ...
        IDataWriter<TKey> IDataWriter.As<TKey>()
        {
            ...
            return new AsDataWriter<string, TKey>(this);
        }
    }
    ...
    internal static class FastObjectRWFactory
    {
        ...
        public static readonly MethodInfo IsDefaultValueMethod = typeof(TypeHelper).GetMethod(nameof(TypeHelper.IsEmptyValue));
        ...
        public static void ImplOnWriteValue<T>(ILGenerator ilGen, FastObjectRWOptions options)
        {
            ...
            for (int i = 0; i < fields.Length; i++)
            {
                ...
                if (field.CanWrite)
                {
                    ...
                    var valueInterfaceIsNoModify = (bool)valueInterfaceType.GetField(nameof(ValueInterface<object>.IsNoModify)).GetValue(null);
        ...
        public static void ImplOnReadAll<T>(ILGenerator ilGen, FastObjectRWOptions options)
        {
            ...
            if ((FastObjectRW<T>.currentOptions & FastObjectRWOptions.SkipDefaultValue) != 0)
            {
                ...
                foreach (var field in fields)
                {
                    if (field.CanRead)
                    {
                        ...
                        var valueInterfaceWriteValueMethod = valueInterfaceType.GetMethod(nameof(ValueInterface<object>.ReverseWriteValue));
            ...
            else
            {
                foreach (var field in fields)
                {
                    ...
                    {
                        var valueInterfaceType = typeof(ValueInterface<>).MakeGenericType(field.Type);
                        var isNoModify = (bool)valueInterfaceType.GetField(nameof(ValueInterface<object>.IsNoModify)).GetValue(null);
